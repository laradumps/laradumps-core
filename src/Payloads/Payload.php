...
abstract class Payload
{
    ...
    public function setExtraContent(array $content): void
    {
    ...
    public function toArray(): array
    {
        ...
        return [
            ...
            'extra_content' => boolval(Config::get('config.send_extra_content')) ? $this->extraContent : [],
        ];
    }
